    ...
    <View style={{backgroundColor:'rgb(1,4,7)',flex:1}}>
        <SafeAreaView style={{flex:1, paddingHorizontal:25, justifyContent:'space-between'}}>
            ...
            <View style={{flexDirection:'row', justifyContent:'center'}}>
                <Text style={{color:'white', fontFamily:'LexendDeca-Thin', fontSize:16}}>Dont have an account? </Text>
                <Pressable><Text style={{color:'rgb(126,202,242)', fontFamily:'LexendDeca-Thin', fontSize:16}}>Sign Up Now</Text></Pressable>
            </View>
